...
a.show();setTimeout(function(){a.focus()})}else i(true)}).appendTo(f);b.mousedown(function(){a.click()}).keydown(function(c){if([13,32,37,38,39,40].indexOf(c.which)!=-1){c.preventDefault();a.click()}});e.size=d.size||5;i()})};
